                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <a href="?action=view&id='.$appoid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Video link</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class=""> 
                        <div class="form-body">
                        <h1>Video chat link</h1>
                        <table border="0" style="margin: 0;padding: 0;width: 70%;">     
                        <form class="" action="emailvideolink.php" method="post">
                        <tr>
                ...
                Client Email  <input type="email" name="email" class="input-text"     value="'.$pemail.'"><br>
                        ...
                        <tr>
                 <tr>
                        <td class="label-td" style="margin: 12%;"> Add Video link here 
                       <input type="text" class="input-text" name="message" placeholder"add video link here" value="https://riley071.github.io/videosdk/"><br> 
                        </td>
                        </tr>
                        <tr>
                        <td>
                        <button class="login-btn btn-primary btn" type="submit" name="send">link</button>
                        </td>
                        </tr>
