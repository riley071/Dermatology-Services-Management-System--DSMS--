...
?>
        <div class="dash-body">
        <!-- <p style="font-size: 23px;padding-left:12px;font-weight: 600;margin-left:20px;">Admin </p>
                             -->
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Dermatologist name or Email" list="doctors">&nbsp;&nbsp;
...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Add New Dermatologist </p>
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Dermatologist (<?php echo $list11->num_rows; ?>)</p>
                    </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New dermatologist.</p><br><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="name" class="input-text" placeholder="dermatologist Name" required><br>
                                </td>
            ...
            ';
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h2>New Psychologist Registered Successfully!</h2>
                                <a class="close" href="doctors.php">&times;</a>
                                <div class="content">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Edit Psychologist Details.</p>
