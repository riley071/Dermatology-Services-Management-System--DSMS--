        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Available Shedules</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <a href="paymentform.php" class="non-style-link"><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Payment</font></button></a>
                                       &nbsp;&nbsp;&nbsp;            </div>
