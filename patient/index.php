                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Have no idea about treatment? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Dermatologist"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your Dermatologist or medical consultant.<br><br>
                            </p>
                            
                            <h3>Channel a Dermatologist Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search  Dermatologist and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
