            ...
            <table class="menu-container" border="0">
                ...
                <!-- <tr class="menu-row" >
                    <td class="menu-btn menu-icon-counselling">
                        <a href="form.php" class="non-style-link-menu"><div><p class="menu-text">Live Counselling</p></a></div>
                    </td>
                </tr> -->
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                            <td style="width: 25%;">
                                    <a href="help/index.html" class="non-style-link">
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div class="btn-icon-back dashboard-icons-setting " style="background-image: url('../img/icons/settings-iceblue.svg');"></div>
                                        <div>
                                                <div class="h1-dashboard" >
                                                    Help & Support
