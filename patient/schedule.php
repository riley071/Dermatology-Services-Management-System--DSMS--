             ...
             <tr class="menu-row" >
                ...
                <!-- <tr class="menu-row" >
                    <td class="menu-btn menu-icon-counselling">
                        <a href="Questionnaire.php" class="non-style-link-menu"><div><p class="menu-text">Live Counselling</p></a></div>
                    </td>
                </tr>
                 -->
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Available schedules</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
