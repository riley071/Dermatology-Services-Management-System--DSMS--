            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="doctors.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">All Dermatologist</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-file">
                        <a href="upload.php" class="non-style-link-menu"><div><p class="menu-text">Upload</p></a></div>
                    </td>
                </tr> 
                <tr class="menu-row" >
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=session&id='.$docid.'&name='.$name.'"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Schedules</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to Doctors Schedules?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                            You want to view All Schedules by <br>('.substr($name,0,40).').
