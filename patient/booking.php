             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-file">
                        <a href="guide.php" class="non-style-link-menu"><div><p class="menu-text">Questionnaire</p></a></div>
                    </td>
                </tr>
                <!-- <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Psychologist</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Psychologist name:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Psychologist Email:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Channeling fee : <b>MWK.2 000.00</b>
